import jpype
from nlp_tools.stanford_parser.standoff import TextStandoff
...
def startJvm():
    ...
    stanford_parser_home = "G:/Master2D/aspect-based survey/AspectSentimentAnalysis/Data/stanford-parser-2010-08-20"
...
class Parser:
    ...
    def parseToStanfordDependencies(self, sentence,show = False):
